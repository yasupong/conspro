...
if (listInventoryRecord != null) {
	...
	for (Iterator iterator = listInventoryRecord.iterator(); iterator.hasNext();) {
		...
		String record = "<td width=\"160\"><a href=\"javascript:void(0)\" onclick=\"loadDetailJa(" + inventoryRecord.getDATE() + ")\"><img src=\"GetPicture?EDITID=" + inventoryRecord.getDATE() + "\" width=\"160\" height=\"120\" title=\"" + inventoryRecord.getOTHER_JA() + "\"><br>" + inventoryRecord.getMANUFACTURER() + "<br>" + inventoryRecord.getNAME() + "</a></td>";
	  out.println(record);
		count++;
	}
}
