...
public class LoadExcelForSellInvSvlt extends HttpServlet {
	...
	protected void service(HttpServletRequest arg0, HttpServletResponse arg1) throws ServletException, IOException {
	    ...
	    String query = "select from " + InventoryRecord.class.getName() + " where BUYER == '' && DATA_FLG == '0' order by TYPE";
	    ...
	    arg1.addHeader("Content-Disposition", "inline; filename=\""+ System.currentTimeMillis() + "InvListForSell.xls\""); 
	    
	    try {
	    	HSSFWorkbook workbook = new HSSFWorkbook();
            HSSFSheet sheet = workbook.createSheet();
            workbook.setSheetName(0,"販売用在庫一覧");  
