	...
	protected void service(HttpServletRequest arg0, HttpServletResponse arg1) throws ServletException, IOException {
	    ...
	    try {
            ...
            for (Iterator<Client> iterator = listClientRecord.iterator(); iterator.hasNext();) {
	            ...
	            cellData06.setCellValue(clientRecord.getCOMPANY());
	            cellData07.setCellValue(clientRecord.getOFFICE());
	            cellData08.setCellValue(clientRecord.getNAME());
	            cellData09.setCellValue(clientRecord.getADDRESS());
	            cellData10.setCellValue(clientRecord.getZIP());
	            cellData11.setCellValue(clientRecord.getTEL());
	            cellData12.setCellValue(clientRecord.getFAX());
	            cellData13.setCellValue(clientRecord.getMAIL());
	            cellData14.setCellValue(clientRecord.getCOMMENT());
